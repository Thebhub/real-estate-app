...
config :ucxChat,
  ecto_repos: [UcxChat.Repo]

# Configures the endpoint
config :ucxChat, UcxChatWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "9yLBttxIRBHUfcg/Z5BwIybQgYT/Qvvu2lWz2siTqzxxa95Sc8nxKXkWch3DvIR8",
  render_errors: [view: UcxChatWeb.ErrorView, accepts: ~w(html json)],
